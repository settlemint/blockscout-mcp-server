...
async def test_get_chains_list_success(mock_ctx):
    ...
    expected_output = (
        "The list of known chains with their ids:\n"
        "Ethereum: 1\n"
        "Polygon PoS: 137"
    )
    ...
    with patch('blockscout_mcp_server.tools.chains_tools.make_chainscout_request', new_callable=AsyncMock) as mock_request:
